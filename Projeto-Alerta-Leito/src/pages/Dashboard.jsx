        ...
        <div className="container d-grid vh-100 g-2 ">
          ...
          <div className="row  d-flex justify-content-around align-items-start">
            <div className="col-auto">
              <div
                className="card mb-3 text-center bg-success text-white"
            ...
            <div className="col-auto">
              <div
                className="card text-bg-warning mb-3 text-white text-center"
                style={{ minWidth: "14rem" }}
              >
            ...
            <div className="col-auto">
              <div
                className="card bg-danger text-white mb-3 text-center "
                style={{ minWidth: "14rem" }}
              >
